...
ALLEGEDLY_LINES.gardenDone = [
  ...
  "some of those clicks were yours.",
  "it took a while. it took every tab.",
  "a small image. a long week.",
  "the canvas is full now. quietly.",
  "done. you can save it, if you want.",
  "every pixel was a tab you let go of.",
  "it adds up to something, evidently."
];
